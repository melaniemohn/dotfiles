...
# Custom colors from: https://misc.flogisoft.com/bash/tip_colors_and_formatting
# For instructions on using color and other formatting:
  # https://makandracards.com/makandra/1090-customize-your-bash-prompt

# For adorable github icons, check out: https://octicons.github.com/

# The commented lines are are the defaults from the "Default" theme; change them and uncomment to override.
override_git_prompt_colors() {
  ...
  GIT_PROMPT_UNTRACKED="${BoldCyan}…"       # the number of untracked files/dirs
  ...
  ## e.g.
  ## GIT_PROMPT_COMMAND_OK="${Green}☺︎-_LAST_COMMAND_STATE_ "    # indicator if the last command returned with an exit code of 0
  ## GIT_PROMPT_COMMAND_FAIL="${Red}☹︎-_LAST_COMMAND_STATE_ "    # indicator if the last command returned with an exit code of other than 0

  GIT_PROMPT_COMMAND_OK="${White}☞"    # indicator if the last command returned with an exit code of 0
  ...
  GIT_PROMPT_START_USER="_LAST_COMMAND_INDICATOR_ \e[38;5;219m${PathShort}${ResetColor}"
  # GIT_PROMPT_START_ROOT="_LAST_COMMAND_INDICATOR_ ${GIT_PROMPT_START_USER}"
  GIT_PROMPT_END_USER=" \n${BoldBlue}${Time12a}${ResetColor} $ "
  GIT_PROMPT_END_ROOT=" \n${BoldBlue}${Time12a}${ResetColor} # "

  ## The default notes, "Please do not add colors to these symbols". I did anyway. Shrug.
  GIT_PROMPT_SYMBOLS_AHEAD="\e[1;38;5;70m↑"             # The symbol for "n versions ahead of origin"
  GIT_PROMPT_SYMBOLS_BEHIND="\e[1;38;5;124m↓"            # The symbol for "n versions behind of origin"
